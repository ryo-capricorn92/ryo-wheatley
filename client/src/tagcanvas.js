/* global jQuery */
/**
 *  Modified by Ryo Wheatley (ryo-capricorn92) 2017-12-16 to accomidate css sprite
...
(function($){
  ...
  function AddImage(i, o, t, tc, x, y) {
   ...
   * @constructor
   */
  function Tag(tc, text, a, v, w, h, x, y, col, bcol, bradius, boutline, bothickness,
  ...
  Tproto.DrawImage = function(c,xoff,yoff,im) {
    var x = this.x, y = this.y, s = this.sc,
      i = im || this.fimage, w = this.w, h = this.h, a = this.alpha, ix = this.ixoff, iy = this.iyoff,
      shadow = this.shadow;
    c.globalAlpha = a;
  ...
  TCproto.CreateTag = function(e) {
    var im, i, t, txt, ts, font, bc, boc, p = [0, 0, 0], x, y;
    ...
    if(ts || i) {
      t = new Tag(this, txt, e, p, 2, this.textHeight + 2, x, y,
